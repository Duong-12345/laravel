                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> websitelogistics.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <!-- <li><a href="{{URL::to('/gio-hang')}}"><i class="fa fa-shopping-cart"></i> Lịch sử</a></li> -->
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Mặt hàng<i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="dropdown"><a href="#">Dịch vụ<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                    <li><a href="https://khachhang.giaohangtietkiem.vn/files/templates/Bieuphi_Giaohangtietkiem.pdf">Delivery fee</a></li>
                    <li><a href="https://khachhang.giaohangtietkiem.vn/files/templates/Tinhthanh_hotro.pdf">
Service area</a></li>
                    <li><a href="https://khachhang.giaohangtietkiem.vn/files/templates/Quydinhdoigoihanghoa.pdf">
Goods packing regulations</a></li>
                  </ul></li>
                                <li><a href="{{URL::to('/video-shop')}}">Blog</a></li>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            <div class="item {{$i==1 ? 'active' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <img alt="{{$slide->slider_desc}}" src="{{asset('public/uploads/slider/'.$slide->slider_image)}}" height="100%" width="100%" class="img img-responsive img-slider">
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2013 E-Logistics Inc. All rights reserved.</p>
